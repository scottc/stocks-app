...
import { useCommsecTransactions } from "@/hooks/useCommsecTransaction";
...
const ChartComponent = ({
  ...
  return (
    ...
    >
      <h2>{initialStockSymbol} Transactions</h2>
      ...
      {match(stocks, {
        ...
        value: (val) => {
          ...
          const profit = (currentPrice - initalBuyPrice) * initialStock;
