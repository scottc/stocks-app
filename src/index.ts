...
const app = new Elysia()
  .get("/*", index)
  .get("/api/commsecholdings", async (req) => await loadHoldings())
  .get("/api/commsectransactions", async (req) => await loadLatestTransactions())
  .get("/api/yahoo/:symbol", async (req) => await yahooApiFetch(req.params.symbol))
